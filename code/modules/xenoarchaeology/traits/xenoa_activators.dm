...
/datum/xenoartifact_trait/activator/weighted
	...
	blacklist_traits = list(/datum/xenoartifact_trait/minor/dense, /datum/xenoartifact_trait/minor/anchor) ///datum/xenoartifact_trait/major/destabilizer readd before PRing
	flags = BLUESPACE_TRAIT | URANIUM_TRAIT
