...
//============
/datum/xenoartifact_trait/malfunction/maltargeting
...
/datum/xenoartifact_trait/malfunction/maltargeting/activate(obj/item/xenoartifact/X, atom/target, atom/user)
	var/mob/living/M
	if(isliving(user))
		M = user
...
/datum/xenoartifact_trait/malfunction/trauma/on_init(obj/item/xenoartifact/X)
	trauma = pick(list(
			...
			/datum/brain_trauma/mild/expressive_aphasia, /datum/brain_trauma/mild/nervous_cough, /datum/brain_trauma/mild/muscle_spasms,
			/datum/brain_trauma/mild/reality_dissociation, /datum/brain_trauma/severe/mute, /datum/brain_trauma/severe/narcolepsy,
			/datum/brain_trauma/severe/discoordination, /datum/brain_trauma/severe/pacifism, /datum/brain_trauma/special/beepsky))
...
//============
// Radioactive - Makes the artifact more radioactive with each use
//============
