/datum/map_generator/dungeon_generator
	...
	var/static/list/overlappable_areas = typecacheof(list(/area/space, /area/debug/procedural_gen))
...
/datum/map_generator/dungeon_generator/combine_local_areas()
	for(var/area/debug/procedural_gen/current_area in GLOB.areas)
...
/datum/map_generator/dungeon_generator/generate_terrain()
	...
	for(var/area/debug/procedural_gen/pg in areas_included)
