...
/datum/biome/jungleland/barren_rocks
	...
	loose_flora = list(/obj/structure/flora/rock = 2)
	loose_flora_density = 10
	cellular_noise_map_id = LOW_DENSITY
	fauna_density = 0.5 
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/random = 33,
...
/datum/biome/jungleland/dry_swamp
	...
	dense_flora = list(/obj/structure/flora/rock/desert = 2)
	loose_flora = list(/obj/structure/flora/ausbushes/stalkybush = 2,
						/obj/structure/flora/rock/desert = 2,
						/obj/structure/flora/stump=2,
						/obj/structure/flora/tree/jungle = 1,
						/obj/structure/herb/cinchona = 0.1,
						/obj/structure/flytrap = 0.1)
	dense_flora_density = 10
	loose_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast = 39,
						/mob/living/simple_animal/hostile/asteroid/goldgrub = 31,
						/mob/living/simple_animal/hostile/yog_jungle/meduracha = 8,
						/mob/living/simple_animal/hostile/yog_jungle/skin_twister = 1,
						/mob/living/simple_animal/hostile/yog_jungle/mosquito = 13,
						/mob/living/simple_animal/hostile/yog_jungle/emeraldspider = 8)
	fauna_density = 0.4
...
/datum/biome/jungleland/swamp
	...
	loose_flora = list(/obj/structure/flora/ausbushes/stalkybush = 2,
						...
						/obj/structure/flora/stump=2,
						/obj/structure/flora/tree/jungle = 1,
						/obj/structure/herb/explosive_shrooms = 0.05,
						/obj/structure/herb/liberal_hats = 0.5,
						/obj/structure/herb/magnus_purpura = 0.5)
	dense_flora = list(/obj/structure/flora/ausbushes/stalkybush = 1)
	loose_flora_density = 20
	dense_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/yog_jungle/blobby = 20,
						/mob/living/simple_animal/hostile/yog_jungle/meduracha = 50,
						/mob/living/simple_animal/hostile/yog_jungle/skin_twister = 2,
						/mob/living/simple_animal/hostile/yog_jungle/mosquito = 46,
...
/datum/biome/jungleland/dying_forest
	...
	dense_flora = list(/obj/structure/flora/stump=1,
						/obj/structure/flora/tree/dead/jungle = 2,
						/obj/structure/flora/rock/desert = 2,
						/obj/structure/herb/cinchona = 0.25)
	dense_flora_density = 50
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/magmawing = 39,
						/mob/living/simple_animal/hostile/yog_jungle/corrupted_dryad = 55,
						/mob/living/simple_animal/hostile/yog_jungle/skin_twister = 1,
						/mob/living/simple_animal/hostile/yog_jungle/mosquito = 5)
	fauna_density = 0.8
...
/datum/biome/jungleland/jungle
	...
	loose_flora = list(/obj/structure/flora/grass/jungle = 3,
						...
						/obj/structure/herb/explosive_shrooms = 0.05,
						/obj/structure/flytrap = 0.1,
						/obj/structure/herb/fruit = 0.2)
	loose_flora_density = 60
	fauna_types = list(/mob/living/simple_animal/hostile/yog_jungle/dryad = 65,
						/mob/living/simple_animal/hostile/yog_jungle/skin_twister = 1,
						/mob/living/simple_animal/hostile/yog_jungle/mosquito = 10,
						/mob/living/simple_animal/hostile/yog_jungle/yellowjacket = 10,
						/mob/living/simple_animal/hostile/yog_jungle/emeraldspider = 14)
	fauna_density = 0.65
