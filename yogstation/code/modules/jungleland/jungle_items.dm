...
/obj/item/organ/regenerative_core/dryad
	name = "dryad heart"
	desc = "A knot of vines slithering within a bark shell. It can be used to heal quickly, but it will rapidly decay into uselessness. Radiation found in active space installments will slow its healing effects."
	icon = 'yogstation/icons/obj/jungle.dmi'
